<%-- 
    ...
    Created on : Nov 20, 2017, 8:03:33 PM
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p>
                Organization: <c:out value="${organization.organizationName}"/> 
            </p>
            <p>
                Organization Description: <c:out value="${organization.organizationDescription}"/>
            </p>
            <p>
            ...
            <p>
                Location: <c:out value="${organization.location.locationName}"/>
            </p>
        </div>
